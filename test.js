...
ne && (S = (w = ne.split("."))[0] > 0 && w[0] < 4 ? 1 : +(w[0] + w[1])),
	!S && J && (!(w = J.match(/Edge\/(\d+)/)) || w[1] >= 74) && (w = J.match(/Chrome\/(\d+)/)) && (S = +w[1]);
var oe = S,
	ie = oe,
	ae = T,
	ce =
...
var Se = "[object z]" === String(we),
	...
	lt = function (e, t) {
		...
		var r,
			n = ct(e, ut);
		if (n) {
			if ((void 0 === t && (t = "default"), (r = ot(n, e, t)), !it(r) || at(r))) return r;
		...
		return (
			...
			(function (e, t) {
				var r, n;
				if ("string" === t && tt((r = e.toString)) && !rt((n = et(r, e)))) return n;
...
var ir = {
		...
		getterFor: function (e) {
			return function (t) {
				var r;
				if (!qt(t) || (r = Ct(t)).type !== e) throw tr("Incompatible receiver, " + e + " required");
				return r;
			};
		},
	},
	...
	mr = (St.exports = function (e, t, r) {
		"Symbol(" === String(t).slice(0, 7) && (t = "[" + String(t).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
			r && r.getter && (t = "get " + t),
			r && r.setter && (t = "set " + t),
			(!sr(e, "name") || (lr && e.name !== t)) && (ur ? dr(e, "name", { value: t, configurable: !0 }) : (e.name = t)),
			gr && r && sr(r, "arity") && e.length !== r.arity && dr(e, "length", { value: r.arity });
		try {
		...
		var n = hr(e);
		return sr(n, "source") || (n.source = vr.join("string" == typeof t ? t : "")), e;
	});
...
var yr = K,
	...
	Tr = function (e, t, r, n) {
		...
		if ((yr(r) && wr(r, i, n), n.global)) o ? (e[t] = r) : Sr(t, r);
			...
			o ? (e[t] = r) : br.f(e, t, { value: r, enumerable: !1, configurable: !n.nonConfigurable, writable: !n.nonWritable });
		}
		return e;
	},
	xr = M,
	...
	kn = function (e, t) {
		return new ((function (e) {
			...
			return (
				Tn(e) &&
					((t = e.constructor),
					((xn(t) && (t === Pn || Tn(t.prototype))) || (En(t) && null === (t = t[On]))) && (t = void 0)),
				void 0 === t ? Pn : t
			);
		})(e))(0 === t ? 0 : t);
	},
...
var so = {},
	...
	mo = function (e) {
		return function (t, r, n) {
			...
			} else for (; a > c; c++) if ((e || c in i) && i[c] === r) return e || c || 0;
			return !e && -1;
		};
	},
	...
	Oo = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"],
	Po = Eo,
...
var ci = Lr,
	si = String,
	ui = function (e) {
		if ("Symbol" === ci(e)) throw TypeError("Cannot convert a Symbol value to a string");
		return si(e);
	},
	li = De,
	fi = T,
...
vi.f =
	mi && !yi
		...
		: function (e, t) {
				wi(e);
				for (var r, n = Si(t), o = Ti(t), i = o.length, a = 0; i > a; ) bi.f(e, (r = o[a++]), n[r]);
				return e;
		  };
var xi,
...
var Fi,
	...
	Ni =
		...
		function (e, t) {
			var r;
			return (
				null !== e ? ((Ci.prototype = Oi(e)), (r = new Ci()), (Ci.prototype = null), (r[ji] = e)) : (r = Ri()),
				void 0 === t ? r : Pi.f(r, t)
			);
		},
	$i = T,
	...
	aa = Gi("".replace),
	ca = Gi("".slice),
	sa = ((Di = /b*/g), zi(ra, (Fi = /a/), "a"), zi(ra, Di, "a"), 0 !== Fi.lastIndex || 0 !== Di.lastIndex),
	ua = qi.BROKEN_CARET,
	la = void 0 !== /()??/.exec("")[1];
(sa || la || ua || Ji || ea) &&
	(na = function (e) {
		var t,
			...
			l = Ki(e),
			f = u.raw;
		if (f) return (f.lastIndex = s.lastIndex), (t = zi(na, f, l)), (s.lastIndex = f.lastIndex), t;
		var h = u.groups,
			p = ua && s.sticky,
			d = zi(Yi, s),
			g = s.source,
		...
		if (
			...
			p
				? o
					? ((o.input = ca(o.input, v)), (o[0] = ca(o[0], v)), (o.index = s.lastIndex), (s.lastIndex += o[0].length))
					: (s.lastIndex = 0)
			...
			for (o.groups = a = Qi(null), i = 0; i < h.length; i++) a[(c = h[i])[0]] = o[c[1]];
		return o;
	});
var fa = na;
		...
		return function (t, r) {
			...
			return a < 0 || a >= c
				? e
					? ""
					: void 0
				: (n = ja(i, a)) < 55296 || n > 56319 || a + 1 === c || (o = ja(i, a + 1)) < 56320 || o > 57343
				? e
					? Aa(i, a)
					: n
				: e
			...
			Ba(i, s, function (i, s) {
				...
				switch ($a(s, 0)) {
					...
					default:
						...
						if (l > c) {
							var f = Na(l / 10);
							return 0 === f ? i : f <= c ? (void 0 === n[f - 1] ? $a(s, 1) : n[f - 1] + $a(s, 1)) : i;
						}
						u = n[l - 1];
				}
				return void 0 === u ? "" : u;
		...
		return [
			...
			function (e, o) {
				...
				for (var p, d = "", g = 0, v = 0; v < f.length; v++) {
					for (var m = cc((h = f[v])[0]), y = dc(gc(ic(h.index), a.length), 0), b = [], w = 1; w < h.length; w++)
		...
		concat: function (e) {
			...
			for (t = -1, n = arguments.length; t < n; t++)
				if (Jc((i = -1 === t ? a : arguments[t])))
					for (o = Hc(i), zc(s + o), r = 0; r < o; r++, s++) r in i && Gc(c, s, i[r]);
	...
	{ target: "Array", proto: !0, forced: !Ss },
	{
		slice: function (e, t) {
			...
			if (
				hs(i) &&
				((r = i.constructor),
				((ps(r) && (r === xs || hs(r.prototype))) || (ds(r) && null === (r = r[Ts]))) && (r = void 0),
				r === xs || void 0 === r)
			)
				return ws(i, c, s);
			for (n = new (void 0 === r ? xs : r)(Es(s - c, 0)), o = 0; c < s; c++, o++) c in i && ys(n, o, i[c]);
			return (n.length = o), n;
		},
	}
);
...
Ds(
	...
	{
		includes: function (e) {
			return !!~Vs(Bs($s(this)), Bs(Ns(e)), arguments.length > 1 ? arguments[1] : void 0);
		},
	}
);
var Us,
...
(Us = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"),
	(Ws = {
		...
		endian: function (e) {
			if (e.constructor == Number) return (16711935 & Ws.rotl(e, 8)) | (4278255360 & Ws.rotl(e, 24));
		...
		bytesToBase64: function (e) {
			for (var t = [], r = 0; r < e.length; r += 3)
				for (var n = (e[r] << 16) | (e[r + 1] << 8) | e[r + 2], o = 0; o < 4; o++)
					8 * r + 6 * o <= 8 * e.length ? t.push(Us.charAt((n >>> (6 * (3 - o))) & 63)) : t.push("=");
			return t.join("");
		},
		base64ToBytes: function (e) {
			...
			for (var t = [], r = 0, n = 0; r < e.length; n = ++r % 4)
				0 != n &&
					t.push(
						((Us.indexOf(e.charAt(r - 1)) & (Math.pow(2, -2 * n + 8) - 1)) << (2 * n)) |
...
var Gs = {
	...
	Ys = function (e) {
		return (
			...
			(qs(e) ||
				(function (e) {
					return "function" == typeof e.readFloatLE && "function" == typeof e.slice && qs(e.slice(0, 0));
				})(e) ||
				!!e._isBuffer)
		);
	};
	...
	var e = zs.exports,
		...
		o = function (i, a) {
			i.constructor == String
				? (i = a && "binary" === a.encoding ? n.stringToBytes(i) : t.stringToBytes(i))
				: r(i)
			...
			for (p = 0; p < c.length; p += 16) {
				...
				(u = d(u, l, f, h, c[p + 0], 7, -680876936)),
					...
					(u = g(u, (l = d(l, f, h, u, c[p + 15], 22, 1236535329)), f, h, c[p + 1], 5, -165796510)),
					...
					(u = v(u, (l = g(l, f, h, u, c[p + 12], 20, -1926607734)), f, h, c[p + 5], 4, -378558)),
					...
					(u = m(u, (l = v(l, f, h, u, c[p + 2], 23, -995338651)), f, h, c[p + 0], 6, -198630844)),
...
var Xs = (function () {
			...
			u(e, [
				{
					...
					value: function () {
						...
						(this.version = es.VERSION), (this.colorTheme = e.colorTheme), (this.iconTheme = e.iconTheme);
				...
				},
				{
					...
					value: function () {
						return (
							...
							(this.thankYouMessageShown = this.globalState.get("thankYouMessageShown", !1)),
				...
				},
				{
					...
					value: function (e) {
						var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
							r = "".concat(e).concat(this.fileIconsMonochrome ? " Monochrome " : " ", "Icons"),
							n = this.vscode.workspace.getConfiguration("workbench"),
							o = n.iconTheme;
						e !== t.colorTheme && n.update("colorTheme", e, !0),
							(this.isValidIconTheme(o) || this.isFirstTime) && r !== t.iconTheme && n.update("iconTheme", r, !0),
							this.load();
					},
				},
				{
				...
				},
				{
					...
					value: function () {
						var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
						return es.APP.THEMES.includes(e.replace(/ (Monochrome )?Icons$/, ""));
					},
				},
				{
					key: "hasValidLicense",
				...
				},
				{
					...
					get: function () {
						return this.isUsingForAWhile
							? this.getCurrentTimeStamp() - this.lastTimeStamp > es.APP.SECONDS_TO_EXPIRE_FAST
							: this.getCurrentTimeStamp() - this.lastTimeStamp > es.APP.SECONDS_TO_EXPIRE;
					},
				},
				{
					key: "isUsingForAWhile",
					get: function () {
						return this.lastTimeStamp - this.firstTimeStamp > es.APP.SLOW_PERIOD;
					},
				},
				{
	...
	Qs = (function () {
		function e(t, r) {
			c(this, e), (this.vscode = t), (this.open = r), (this.state = null), (this.timeout = null);
		}
		return (
			u(e, [
				{
					...
					value: function (e) {
						...
						Object.keys(r).forEach(function (n) {
							...
							this.vscode.workspace.onDidChangeConfiguration(function () {
								var e = t.state.get(),
									r = t.state.load();
								t.state.hasActiveMonokaiProColorTheme && t.state.updateTheme(r.colorTheme, e);
							}),
							(this.state.hasActiveMonokaiProColorTheme || this.state.hasActiveMonokaiProIconTheme) &&
								this.checkLicense();
					},
				},
				{
					...
					value: function () {
						...
						this.vscode.window
							.showInputBox({
								...
								prompt: "Please enter the email address you've used to purchase your license (or type 'reset' to reset your license).",
								validateInput: function (e) {
									return "reset" === e || /.+@.+\..+/i.test(e) ? null : "Please enter a valid email address.";
								},
							})
							.then(function (t) {
									...
									: r &&
									  e.vscode.window
											.showInputBox({
												...
												prompt: "Please enter your Monokai Pro license key.",
											})
											.then(function (t) {
												if (t) {
													var n = t.replace(/^\s+|\s+$/g, "");
													e.state.update("email", r),
														e.state.update("licenseKey", n),
														e.state.isValidLicense(r, n) || e.state.isValidLicense(r.toLowerCase(), n)
				...
				},
				{
					...
					value: function () {
						...
						es.APP.THEMES.forEach(function (e) {
							...
							this.vscode.window.showQuickPick(t, { placeHolder: "Monokai Pro theme" }).then(function (t) {
				...
				},
				{
					key: "activateIcons",
					value: function () {
						this.vscode.workspace.getConfiguration("workbench").update("iconTheme", "Monokai Pro Icons", !0);
					},
				},
				{
					key: "checkLicense",
					value: function () {
						...
						this.state.hasValidLicense
							? (clearTimeout(this.timeout), this.state.thankYouMessageShown || this.showMessageValidLicense())
							: this.state.isExpired &&
							  ...
							  this.state.update("lastTimeStamp", this.state.getCurrentTimeStamp()));
					},
				},
				{
					key: "deactivate",
				...
				},
				{
					...
					value: function () {
						this.vscode.window.showInformationMessage("Monokai Pro license information is reset");
					},
				},
				{
					...
					value: function () {
						clearTimeout(this.timeout),
							this.vscode.window.showInformationMessage("Thanks for your purchase of Monokai Pro.", { modal: !0 }),
				...
				},
				{
					...
					value: function () {
						var e = this,
							t = { theme: this.state.colorTheme, version: es.APP.VERSION, name: es.APP.NAME },
							r = Object.keys(t)
								.map(function (e) {
						...
						this.vscode.window
							...
							.then(function (t) {
								t &&
									"OK" === t.toUpperCase() &&
									(e.open
										? e.open("https://monokai.pro?".concat(r))
										: e.vscode.env.openExternal("https://monokai.pro?".concat(r)));
							});
					},
				},
				{
...
var tu = () => (
	void 0 === eu &&
		(eu =
			...
			(function () {
				try {
					return Js.readFileSync("/proc/self/cgroup", "utf8").includes("docker");
				} catch (e) {
					return !1;
				}
			})()),
...
const ru = o,
	...
	iu = () => {
		...
		try {
			return !!nu.readFileSync("/proc/version", "utf8").toLowerCase().includes("microsoft") && !ou();
		} catch (e) {
			return !1;
		}
	};
...
const au = t,
	...
	fu = tu,
	hu = (e, t, r) => {
		const n = (r) => Object.defineProperty(e, t, { value: r, enumerable: !0, writable: !0 });
		return (
	...
	vu = (() => {
		...
		return async function () {
			...
			return i ? ((t = i.groups.mountPoint.trim()), (t = t.endsWith("/") ? t : `${t}/`), t) : e;
		};
	})(),
	mu = async (e, t) => {
		let r;
	...
	yu = async (e) => {
		...
		if (((n = [...n]), Array.isArray(r))) return mu(r, (t) => yu({ ...e, app: { name: t, arguments: n } }));
		const o = [],
			i = {};
		if ("darwin" === du)
			(t = "open"),
			...
			e.wait && c.push("-Wait"),
				r
					? (c.push(`"\`"${r}\`""`, "-ArgumentList"), e.target && n.unshift(e.target))
					: e.target && c.push(`"${e.target}"`),
				n.length > 0 && ((n = n.map((e) => `"\`"${e}\`""`)), c.push(n.join(","))),
			...
			if (r) t = r;
				...
				t = process.versions.electron || "android" === du || e || !r ? "xdg-open" : pu;
			}
			n.length > 0 && o.push(...n), e.wait || ((i.stdio = "ignore"), (i.detached = !0));
		}
		e.target && o.push(e.target), "darwin" === du && n.length > 0 && o.push("--args", ...n);
		const a = cu.spawn(t, o, i);
		return e.wait
			? new Promise((t, r) => {
					a.once("error", r),
						a.once("close", (n) => {
							e.allowNonzeroExitCode && n > 0 ? r(new Error(`Exited with code ${n}`)) : t(a);
						});
			  })
			: (a.unref(), a);
	},
